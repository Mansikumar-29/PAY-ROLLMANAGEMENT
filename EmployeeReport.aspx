<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeReport.aspx.cs" Inherits="PayRoll.EmployeeReport" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div style="overflow: scroll">
                <center >
            <asp:GridView ID="gdvemployee" runat="server" AutoGenerateColumns="false" OnPageIndexChanging="gdvemployee_PageIndexChanging" AllowPaging="true"
                 PageSize="8" GridLines="None" EmptyDataText="NoRecordFound" EmptyDataRowStyle-ForeColor="Red"
                 Width="100%" CssClass="table table-bordered table-striped" OnRowCommand="gdvemployee_RowCommand">
                     <Columns>
